    ...
    <div class="main_block_container container">
      <div class="main_block_body">
        <form class="form">
          ...
          <input class="form_input" id="searchField" type="text" placeholder="Поиск по названию или ингредиенту">
        </form>
        <div class="recipes_block">
          <div class="recipe_item" v-for="recipe in recipes" :key="recipe.id_recipe">
            <Card :recipe="recipe"/>
          </div>
        </div>
      </div>
...
.search_button {
  background: url(../../../../OneDrive/Desktop/MainPageSite/images/icons/search.png) 0 0/ 100% auto no-repeat;
  width: 25px;
  height: 25px;
  border: none;
  position: absolute;
